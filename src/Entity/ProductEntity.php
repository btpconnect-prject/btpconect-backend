...
#[ApiResource(
    ...
    operations: [
        ...
        new Delete(uriTemplate: "/product/{id}",   processor: StateProductProcessorPost::class)
    ]
)]
...
class ProductEntity
{
     ...
     */
    #[ORM\OneToMany(targetEntity: MediaObject::class, mappedBy: 'product', cascade: ["persist", "remove", "detach"])]
    #[Groups(["product::read", 'mediaObject::read'])]
